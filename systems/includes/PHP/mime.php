...
if (!function_exists("exif_imagetype") || !function_exists("image_type_to_mime_type")) {
    ...
    if (!defined('IMAGETYPE_SWF')) define("IMAGETYPE_SWF", 4);
    if (!defined('IMAGETYPE_PSD')) define("IMAGETYPE_PSD", 5);  // post-4.3 from here ...
    ...
    if (!defined('IMAGETYPE_JPC')) define("IMAGETYPE_JPC", 9);
    if (!defined('IMAGETYPE_JP2')) define("IMAGETYPE_JP2", 10);
    if (!defined('IMAGETYPE_JPX')) define("IMAGETYPE_JPX", 11);
    if (!defined('IMAGETYPE_JB2')) define("IMAGETYPE_JB2", 12);
    if (!defined('IMAGETYPE_SWC')) define("IMAGETYPE_SWC", 13);
    if (!defined('IMAGETYPE_IFF')) define("IMAGETYPE_IFF", 14);
    if (!defined('IMAGETYPE_WBMP')) define("IMAGETYPE_WBMP", 15);
    if (!defined('IMAGETYPE_XBM')) define("IMAGETYPE_XBM", 16);
    if (!defined('IMAGETYPE_MNG')) define("IMAGETYPE_MNG", 77);
    if (!defined('IMAGETYPE_XPM')) define("IMAGETYPE_XPM", 88);
    if (!defined('IMAGETYPE_ZIF')) define("IMAGETYPE_ZIF", 90);
    if (!defined('IMAGETYPE_PBM')) define("IMAGETYPE_PBM", 80);
    if (!defined('IMAGETYPE_PGM')) define("IMAGETYPE_PGM", 81);
    if (!defined('IMAGETYPE_PPM')) define("IMAGETYPE_PPM", 82);
