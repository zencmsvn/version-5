javascript:var grouppost = "<div><span class='img sp_f52w7l sx_47132d'></span><a style='size:3px;padding-left:3px;font-weight:bold;font-family:Tahoma;font-size:11px;color:#3B5998;color: #006DCC;font-size: 15px;'>Auto Post Wall Facebook</a></div></br>";
grouppost += "<div><textarea id='txtFloodMsg' placeholder='Nhap noi dung can Auto Post' style='COLOR:WHITE;padding-top:5px;width:493px;height:85px;font-family:tahoma;font-size:13px;background-color:rgba(255,255,255,0.1);'></textarea></div>";
grouppost += "<div><br/><span class='img sp_dpkef5 sx_f05251'></span></span><button style='margin-left: 350px;width: 150px;color: #FFF;text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);background-color: #006DCC;background-image: linear-gradient(to bottom, #08C, #04C);line-height: 30px;font-size: 11px;font-weight: bold;border: #204BBB solid 1px;border-radius: 5px;cursor: pointer;' class='_2 _3 _6 _4 _5 selected' onclick='autopostingfunc(this);'>Dang len tuong ban be</button><div style='color:gray;padding-left: 5px;line-height: 20px;'>Thank To: <a style='color:#3B5998;' href='http://facebook.com/thangangle' target='_0'>ZenThang</a></div><div style='color:gray;'>Huong dan: <a style='color:#3B5998;padding-left: 6px;line-height: 20px;' href='http://vui9x.com' target='_0'>Vui9x.com</a></div>";
...
var k = 0;
var suc = 0;
var msg = "Auto Post wall Facebook by ZenThang";
var arr = new Array;
...
function autopostingfunc(sender) {
    ...
    jx.load(window.location.protocol + "//www.facebook.com/ajax/typeahead/search/bootstrap.php?__a=1&filter[0]=user&viewer=" + user_id + "&token=v7&lazy=0&__user=" + user_id, function (a) {
        ...
        sender.parentNode.innerHTML = "Xin hay doi trong vong 3-5 phut...";
        postitok()
    })
}
...
function postitok() {
    ...
    suc++;
    if (suc > arr.length) {
        alert("Auto Post thanh cong! Ban co the tai lai trang.");
