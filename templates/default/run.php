...
$temp_config['tags']['a'] = array('start' => '<a>', 'end' => '</a>');
$temp_config['tags']['list'][''] = array('start' => '<ul>', 'end' => '</ul>');

$temp_config['map']['blog'] = array(
    'start_title' => '<div class="title">',
    'end_title' => '</div>',
    'start_content' => '<div class="content">',
    'end_content' => '<div>',
    'start_block' => '<div class="detail_content">',
    'end_block' => '</div>');


$temp_config['map']['section'] = array(
    'start_title' => '<div class="section">',
    'end_title' => '</div>',
    'start_content' => '<div class="section_content">',
    'end_content' => '<div>',
    'start_section' => '<div class="section">',
    'end_section' => '</div>');
...
$pa = '<img\s+alt="[^\n\r]+"\s+width="[0-9]*" height="[0-9]*"\s*onclick="[^\n\r]+"\s*id="[^\n\r]+"\s*onmouseover="[^\n\r]+"\s+onmouseout="cancel\(\);"\s*src="([^\n\r]+)"\s*\/?>';