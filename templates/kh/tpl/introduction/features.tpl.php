...
<td class="zen_main">
    ...
    <table class="tbl_features">
        <tr>
            <td>
                <div class="index_title">Với ZenCMS bạn có thể</div>
                <p>
                    Bạn có ý tưởng và chúng tôi đã chuẩn bị sẵn cho bạn:<br/>
                    1: Một trang Blog game, Blog truyện, hình ảnh hoặc video trên nền module "blog" - Module chính của ZenCMS<br/>
                    2: Một Forum<br/>
                    3: Một Chatbox<br/>
            ...
            <td>
                <div class="index_title">Quản lí bài viết</div>
                <p>
        ...
        <tr>
            ...
            <td>
                <div class="index_title">Quản lí thành viên</div>
                <p>
            ...
            <td>
                <div class="index_title">Tính năng đặc biệt</div>
                <p>
        ...
        <tr>
            ...
            <td>
                <div class="index_title">Tính năng chia sẻ</div>
                <p>
            ...
            <td>
                <div class="index_title">Tính tương tác</div>
                <p>
        ...
        <tr>
            ...
            <td>
                <div class="index_title">Quản trị thông minh</div>
                <p>
            ...
            <td>
                <div class="index_title">Cài đặt đơn giản</div>
                <p>
