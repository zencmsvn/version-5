    ...
    <div class="header">
        ...
        <div id="menu">
            <ul>
                ...
                <li class="separator">
                    <a href="<?php echo _HOME ?>/huong-dan-su-dung-2.html" title="Hướng dẫn sử dụng code ZenCMS">Hướng dẫn</a>
                </li>
                <li class="separator">
                    <a href="<?php echo _HOME ?>/introduction/features" title="Tính năng của ZenCMS">Tính năng</a>
                </li>
                <li class="separator">
                    <a href="<?php echo _HOME ?>/blog" title="Blog ZenCMS">Blog</a>
                </li>
                <li class="separator">
                    <a href="http://basic.zencms.vn" title="Blog ZenCMS">Diễn đàn</a>
                </li>
                <?php if (IS_MEMBER): ?>
                    <li class="separator">
