...
function tplfunc_admin_bootstrap_get_new_by_cat($catid, $num = 2) {

    global $registry;

    $id = $catid;

    static $tplfunc_admin_bootstrap_get_new_by_cat;

    if (isset($tplfunc_admin_bootstrap_get_new_by_cat[$id])) {

        return $tplfunc_admin_bootstrap_get_new_by_cat[$id];
    }

    $query = 'tplfunc_admin_bootstrap_get_new_by_cat_' . $id;
    /**
     * get cache
     */
    ...
    foreach($list as $item) {
        ...
        if ($item['type'] == 'post') {
            ...
            $list_chil = tplfunc_admin_bootstrap_get_new_by_cat($item['id'], null);
    ...
    $tplfunc_admin_bootstrap_get_new_by_cat[$id] = $out;
