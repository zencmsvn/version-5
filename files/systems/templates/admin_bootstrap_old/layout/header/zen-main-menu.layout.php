<a class="navbar-brand active zen-cp-logo" href="<?php echo _HOME ?>" title="<?php echo get_config('title') ?>"><img src="http://localhost/files/systems/images/zen-cp-logo.png"/></a>
