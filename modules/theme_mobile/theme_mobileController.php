...
Class theme_mobileController Extends ZenController
{
    ...
    function collection($request_data = array())
    {
        ...
        if( !empty ($collect_name) ) {
            ...
            $url = $collect_name;
            $path = 'giaodien/'.$collect_name;
            $path_down = 'giaodien/'.$collect_name;
        }  else {
            $url = '';
            $path = 'giaodien';
        }
        ...
        for ( $j = $start ; $j <= $start + $show; $j++) {
            ...
            if ( isset($folders[$j]) && !in_array($folders[$j], $inor) ) {
                ...
                if (is_file($file)) {
                    ...
                    $fodata['title'] = $fo;
                    $fodata['name'] = $fo;
                    $fodata['link'] = _HOME.'/theme_mobile/collection/'.$fo;
        ...
        if (!empty($data['file_list'])) {
            ...
            $data['page_title'] = $collect_name . ' Tải theme mobile| Theme giao diện đẹp cho điện thoại';
            $this->view->data = $data;
            $this->view->show('theme_mobile/thumuc');
        }else {

            $data['page_title'] = 'Tải theme mobile| Theme giao diện đẹp cho điện thoại';
            $this->view->data = $data;
            $this->view->show('theme_mobile/index');
        }
    }
