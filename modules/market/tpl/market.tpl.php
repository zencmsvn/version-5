...
<?php phook('market_before_top_new', '') ?>
...
<?php phook('market_after_top_new', '') ?>

<!-- end top new -->


<!-- start top hot -->
<?php phook('market_before_top_hot', '') ?>
...
<?php phook('market_after_top_hot', '') ?>
...
<?php phook('market_before_display_cat', '') ?>
...
<?php if (empty($cats)): ?>
    ...
    <div class="notice">
        ...
        <?php if (is(ROLE_MANAGER)): ?>
            <br/>Click vào <b><a href="<?php echo _HOME ?>/market/manager/cpanel">đây</a></b> và bắt đầu thêm nội dung
        <?php endif ?>
    </div>
    ...
    <?php foreach ($cats as $id => $cat): ?>
        ...
        <?php if (!empty($cat['sub_cat'])): ?>
            ...
            <div class="detail_content">
                ...
                <?php phook('market_before_list_sub_cat', '') ?>
                ...
                <?php phook('market_after_list_sub_cat', '') ?>
            </div>

            <?php phook('market_after_cat', '') ?>
...
<?php phook('market_after_display_cat', '') ?>
