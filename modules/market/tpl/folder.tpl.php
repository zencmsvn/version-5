...
<?php phook('market_folder_before_title', '') ?>

<div class="detail_content">
    <h1 class="title border_blue"><?php echo $market['name'] ?></h1>
</div>

<?php phook('market_folder_after_title', '') ?>
...
<?php phook('market_folder_before_list_post', '') ?>
...
<?php phook('market_folder_after_list_post', '') ?>
...
<?php phook('market_folder_before_list_folder', '') ?>
...
<?php phook('market_folder_after_list_folder', '') ?>
...
<?php phook('market_folder_before_rand_post', '') ?>
...
<?php phook('market_folder_after_rand_post', '') ?>
...
<?php phook('market_folder_before_same_cat', '') ?>
...
<?php phook('market_folder_after_same_cat', '') ?>
