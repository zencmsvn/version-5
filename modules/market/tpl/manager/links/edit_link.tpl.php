...
<?php load_message(); ?>
    ...
    <div class="detail_content">
        ...
        <div class="item_non_border">
            <a href="<?php echo _HOME ?>/market/manager/links/<?php echo $market['id'] ?>/step2" class="button BgBlue">Trở
                lại</a>
        </div>
    </div>
    ...
    <div class="detail_content">
        ...
        <form method="post">
            ...
            <div class="item_non_border">
                ...
                <a href="<?php echo _HOME ?>/market/manager/links/<?php echo $market['id'] ?>/step2/delete/<?php echo $link['id'] ?>"
