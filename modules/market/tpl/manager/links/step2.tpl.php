...
<?php load_message(); ?>
    ...
    <div class="detail_content">
        ...
        <div class="tip">
            ...
            <i><u><a href="<?php echo _HOME ?>/market/manager/files/<?php echo $market['id'] ?>/step2">Quản lí file</a></u></i>
        </div>
        ...
        <div class="item_non_border">
            ...
            <a href="<?php echo _HOME ?>/market/manager/links/<?php echo $market['id'] ?>/step2/add"
               class="button BgBlue">Thêm link</a>
        </div>

        <?php foreach ($market['links'] as $link): ?>
            <div class="item">
            <span class="button_manager">
                <a href="<?php echo _HOME; ?>/market/manager/links/<?php echo $market['id'] ?>/step2/edit/<?php echo $link['id']; ?>"
                   title="Chỉnh sửa">
