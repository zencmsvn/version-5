...
<?php load_message() ?>
    ...
    <div class="detail_content">
        <h2 class="title border_blue">
            Sửa bài -
            <a href="<?php echo $market['full_url'] ?>" target="_blank">
                <?php echo $market['name'] ?>
            </a>
        </h2>

        <div class="tip">
            Bạn đang viết bài trong chế độ <b style="color:red"><?php echo $market['type_data']; ?></b> -
            <u>
                <a href="<?php echo _HOME; ?>/market/manager/editpost/<?php echo $market['id']; ?>/step2/unset">
            ...
            <div class="item">
                ...
                <select name="to">
                    <?php foreach ($tree_folder as $id => $name): ?>
                        <option value="<?php echo $id ?>" <?php if ($market['parent'] == $id) echo 'selected' ?>>
                            <?php echo $name ?>
                        </option>
                    <?php endforeach ?>
                </select>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="item_manager"><?php echo icon('item'); ?> Tên:<br/>
                <input type="text" name="name" value="<?php echo $market['name']; ?>" placeholder="Nhập tên bài viết"/>
            </div>
            ...
            <div class="item_manager">
                ...
                <div class="tip">
                    Tiêu đề cũ: <b><?php echo $market['title'] ?></b>
                </div>
                <label for="type_title_custom">
                    <input type="text" name="custom_title" value="<?php echo $market['custom_title']; ?>"
                           placeholder="Tùy chỉnh tiêu đề"/><br/>
                </label>
                Hoặc:<br/>
                <label for="type_title_custom">
                    <input type="radio" name="type_title" value="custom"
                           id="type_title_custom" <?php echo $market['check_title_custom']; ?> /> Tùy chỉnh<br/>
                </label>
                <label for="type_title_only_me">
                    <input type="radio" name="type_title" value="only_me"
                           id="type_title_only_me" <?php echo $market['check_title_only_me']; ?> /> Chỉ tính title bài
                    này<br/>
                </label>
                <label for="type_title_with_parent">
                    <input type="radio" name="type_title" value="with_parent"
                           id="type_title_with_parent" <?php echo $market['check_title_with_parent']; ?> /> Bao gồm cả
                    title thư mục trước<br/>
                </label>
                <label for="type_title_with_full_parent">
                    <input type="radio" name="type_title" value="with_full_parent"
                           id="type_title_with_full_parent" <?php echo $market['check_title_with_full_parent']; ?> /> Bao
            ...
            <div class="item_manager">
                ...
                <label for="type_url_only_me">
                    <input type="radio" name="type_url" value="only_me"
                           id="type_url_only_me" <?php echo $market['check_url_only_me']; ?> /> Chỉ tính url bài này<br/>
                </label>
                <label for="type_url_with_parent">
                    <input type="radio" name="type_url" value="with_parent"
                           id="type_url_with_parent" <?php echo $market['check_url_with_parent']; ?> /> Bao gồm cả url 1
                    thư mục trước<br/>
                </label>
                <label for="type_url_with_full_parent">
                    <input type="radio" name="type_url" value="with_full_parent"
                           id="type_url_with_full_parent" <?php echo $market['check_url_with_full_parent']; ?> /> Bao gồm
            ...
            <div class="item_manager">
                ...
                <textarea name="content" style="width:100%;" rows="15"
                          id="content"><?php echo $market['content']; ?></textarea>
            </div>

            <div class="item_manager"><?php echo icon('item'); ?> Keyword:<br/>
                <textarea name="keyword" style="width:100%;" rows="5"
                          placeholder="Phần keyword nằm trong thẻ meta keyword"><?php echo $market['keyword']; ?></textarea>
            </div>
            <div class="item_manager"><?php echo icon('item'); ?> Mô tả:<br/>
                <textarea name="des" style="width:100%;" rows="5"
                          placeholder="Phần mô tả nằm trong thẻ meta description"><?php echo $market['des']; ?></textarea>
            </div>
            <div class="item_manager"><?php echo icon('item'); ?> Tags:<br/>
                <textarea name="tags" style="width:100%;" rows="3"
                          placeholder="Mỗi tag cách nhau bằng dấu ,"><?php echo $market['tags'] ?></textarea>
            </div>
            <div class="item_manager">
                <?php echo icon('item'); ?> Icon (Chọn 1 trong 2 cách sau):
                <div style="text-align: center;"><img src="<?php echo $market['full_icon'] ?>"></div>
                <p>
