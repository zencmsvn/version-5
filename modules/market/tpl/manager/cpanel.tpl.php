...
<?php load_message() ?>
    ...
    <div class="detail_content">
        ...
        <?php if (!count($cats)): ?>
            ...
            <div class="tip">
                <b><u><a href="<?php echo _HOME ?>/market/manager/cpanel/<?php echo $sid; ?>/add/0/<?php echo $sid; ?>">Thêm một mục</a></u></b>
            </div>
            ...
            <?php foreach ($cats as $id => $cat): ?>
                ...
                <div class="item">
                    <?php foreach($cat['navi'] as $navi): ?>
                        <?php echo $navi; ?>
                    <?php endforeach; ?>
                    <a href="<?php echo _HOME ?>/market/manager/cpanel/<?php echo $id; ?>" title="<?php echo $cat['title']; ?>"><?php echo $cat['name']; ?></a>
                </div>
