...
<?php load_message(); ?>
    ...
    <div class="detail_content">
        ...
        <div class="item_non_border">
            <a href="<?php echo _HOME ?>/market/manager/files/<?php echo $market['id'] ?>/step2" class="button BgBlue">Trở lại</a>
            <a href="<?php echo _HOME ?>/market/manager/files/<?php echo $market['id'] ?>/step2/add?remote" class="button BgGreen">Nhập khẩu từ xa</a>
