...
<div class="detail_content">
    ...
    <div class="content">
        <div class="tip">
            Bạn có muốn chuyển
            <b><?php if ($market['type'] == 'folder'): ?>Thư mục<?php else: ?>Bài Viết<?php endif; ?></b>
            <b><a href="<?php echo $market['full_url']; ?>" target="_blank"><?php echo $market['name']; ?></a></b> vào
            thùng rác?
        </div>
        <form method="post">
            ...
            <a href="<?php echo _HOME ?>/market/manager" class="button BgGreen">Hủy</a>
        </form>
    </div>
</div>
<?php load_footer(); ?>
