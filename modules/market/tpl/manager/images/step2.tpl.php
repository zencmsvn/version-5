    ...
    <div class="detail_content">
        ...
        <div class="tip">
            <?php if (isset($_GET['content'])): ?>
                ...
                <b><u>(<a href="<?php echo _HOME ?>/market/manager/images/<?php echo $market['id'] ?>/step2">Xem ảnh tải
                            lên</a>)</u></b>
            <?php else: ?>
                Bạn đang xem ảnh tải lên
                <b><u>(<a href="<?php echo _HOME ?>/market/manager/images/<?php echo $market['id'] ?>/step2?content">Lọc
        ...
        <div class="item_non_border">
            ...
            <a href="<?php echo _HOME ?>/market/manager/images/<?php echo $market['id'] ?>/step2/add"
               class="button BgBlue">Tải ảnh từ máy</a>
            <a href="<?php echo _HOME ?>/market/manager/images/<?php echo $market['id'] ?>/step2/add?remote"
        ...
        <h2 class="sub_title border_orange">
            <?php if (isset($_GET['content'])): ?>
                ...
                <span class="text_smaller">
                    (<a href="<?php echo _HOME ?>/market/manager/images/<?php echo $market['id'] ?>/step2">Xem ảnh tải
                        lên</a>)
                </span>
            <?php else: ?>
                Danh sách ảnh tải lên
                <span class="text_smaller">
                    (<a href="<?php echo _HOME ?>/market/manager/images/<?php echo $market['id'] ?>/step2?content">Lọc ảnh
                        lấy từ bài viết</a>)
                </span>
            <?php endif; ?>
        </h2>

        <?php if (!count($market['images'])): ?>
            <div class="tip">Hiện tại chưa có ảnh nào</div>
        <?php else: ?>

            <form method="POST">

                <?php foreach ($market['images'] as $image): ?>
                    <div class="item">
