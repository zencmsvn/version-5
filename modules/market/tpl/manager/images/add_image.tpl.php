...
<?php load_message(); ?>
    ...
    <div class="detail_content">
        <h2 class="sub_title border_blue"><a href="<?php echo $market['full_url'] ?>"
                                             target="_blank"><?php echo $market['name'] ?></a></h2>

        <div class="item_non_border">
            <a href="<?php echo _HOME ?>/market/manager/images/<?php echo $market['id'] ?>/step2" class="button BgBlue">Trở lại</a>
            <a href="<?php echo _HOME ?>/market/manager/images/<?php echo $market['id'] ?>/step2/add?remote" class="button BgGreen">Nhập khẩu từ xa</a>
