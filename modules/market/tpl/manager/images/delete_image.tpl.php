...
<?php load_message(); ?>
    ...
    <div class="detail_content">
        ...
        <div class="item_non_border">
            <a href="<?php echo _HOME ?>/market/manager/images/<?php echo $market['id'] ?>/step2"
    ...
    <div class="detail_content">
        <h2 class="sub_title">
            Xóa: <a href="<?php echo $image['full_url']; ?>" target="_blank"><?php echo $image['file_name']; ?></a>
        </h2>

        <form method="post">
            <div class="item_non_border">Bạn có muốn xóa file này? Tất cả dữ liệu liên quan đến file sẽ bị xóa</div>
            <div class="item_non_border">
                <input type="hidden" name="token_delete_image" value="<?php echo $token; ?>"/>
