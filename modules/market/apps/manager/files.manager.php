...
$tree[] = url(_HOME . '/market/manager/files', $page_title);
...
switch ($step) {
    default:
        ...
        if (empty($sid) or $model->market_exists($sid) == false) {
                    ...
                    if (!empty($cid)) {
                        ...
                        if ($model->market_exists($cid) == false) {
                            ...
                            if ($market['type'] != 'post') {
                                ...
                                redirect(_HOME . '/market/manager/files/' . $cid . '/step2');
                            }
                        }
                    } else {
            ...
            $obj->view->data = $data;
            $obj->view->show('market/manager/files/step1');
            return;
        } else {

            redirect(_HOME . '/market/manager/files/' . $sid . '/step2');
        }
        break;
    ...
    case 'step2':
        ...
        if (empty($sid) or $model->market_exists($sid) == false) {
            redirect(_HOME . '/market/manager/files');
        }
        ...
        switch ($act) {
            ...
            default:
                ...
                $data['market'] = $market;
                $data['market']['files'] = $files;
                $data['java'] = $java;
                $obj->view->data = $data;
                $obj->view->show('market/manager/files/step2');
                break;
            ...
            case 'add':
                ...
                if (isset($_GET['remote'])) {
                    ...
                    $obj->view->show('market/manager/files/add_file_remote');
                } else {
                    $obj->view->show('market/manager/files/add_file');
                }
                break;
            ...
            case 'edit':
                ...
                $obj->view->data = $data;
                $obj->view->show('market/manager/files/edit_file');
                break;
            ...
            case 'delete':
                ...
                $data['file'] = $file;
                $obj->view->data = $data;
                $obj->view->show('market/manager/files/delete_file');
                break;
        }
        break;
}
