...
switch ($step) {
    default:
        ...
        if (empty($sid) or $model->market_exists($sid) == false) {
                    ...
                    if (!empty($cid)) {
                        ...
                        if ($model->market_exists($cid) == false) {
                            ...
                            if ($market['type'] != 'post') {
                                ...
                                redirect(_HOME . '/market/manager/images/' . $cid . '/step2');
                            }
                        }
                    } else {
            ...
            $obj->view->data = $data;
            $obj->view->show('market/manager/images/step1');
            return;
        } else {
            redirect(_HOME . '/market/manager/images/' . $sid . '/step2');
        }
        break;
    ...
    case 'step2':
        ...
        /**
         * make sure market is exits
         */
        if (empty($sid) or $model->market_exists($sid) == false) {

            redirect(_HOME . '/market/manager/images');
        }
        ...
        switch ($act) {
            ...
            default:
                ...
                $data['market'] = $market;
                $data['market']['images'] = $images;
                $obj->view->data = $data;
                $obj->view->show('market/manager/images/step2');
                break;
            ...
            case 'add':
                ...
                if (isset($_GET['remote'])) {
                    ...
                    $obj->view->show('market/manager/images/add_image_remote');
                } else {

                    $obj->view->show('market/manager/images/add_image');
                }
                break;
