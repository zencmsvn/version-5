<?php load_header() ?>
    <div class="detail_content">
        ...
        <div class="content" style="line-height: 30px;">
            <div class="item_non_border">
                ...
                mình<br/>
                Ok. Bây giờ hãy tiếp tục ghé thăm trang <b><a href="<?php echo _HOME ?>" target="_blank">quản trị</a></b> nhé<br/>
            </div>
            <div class="item_non_border">
            ...
            <div class="item_non_border">
                Nếu có bất kì thắc mắc gì vui lòng qua website
    ...
    <div class="detail_content">
        ...
        <div class="item">
            <?php echo icon('item') ?> <a href="http://zencms.vn/market" target="_blank" title="ZenMarket">Chợ ứng
                dụng</a>
        </div>
    </div>
<?php load_footer() ?>